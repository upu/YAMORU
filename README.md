...
家族招待、二人以上でのデータ共有、一回限りTodo、固定日基準Todo、延期、PWAは未対応です。これらはPhase 2以降のスコープであり、詳細は[プロダクト計画](docs/product/yamoru-project-plan.md)の該当Phaseを参照してください。現在は一人で使う前提の最小縦切りであり、二人以上の家庭内共有はまだ動作しません。
