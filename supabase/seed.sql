...
-- managed_items
-- ---------------------------------------------------------------------------
insert into public.managed_items (id, household_id, name) values
  ('00000000-0000-0000-0000-0000000aa001', '00000000-0000-0000-0000-00000000a001', '家庭Aの管理対象(テスト用)'),
  ('00000000-0000-0000-0000-0000000bb001', '00000000-0000-0000-0000-00000000b001', '家庭Bの管理対象(テスト用)');
