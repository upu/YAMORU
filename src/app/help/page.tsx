...
const USAGE_TOPICS: {
  ...
  },
  {
    ...
    kinds: [
      { detail: "家電や住宅設備など、家にあるもの。", term: "備品" },
      // YDR-036: サービス・契約は、サービス提供・契約に加えて税金や公的支払いも
      // 含む大分類。詳しい種類のプリセットも契約・習い事・固定資産税なので、
      // 「契約して使っているもの」だけだと登録できる対象を狭く見せてしまう。
      {
        detail: "契約や習い事、税金など、物として家にはないもの。",
        term: "サービス・契約",
      },
      {
